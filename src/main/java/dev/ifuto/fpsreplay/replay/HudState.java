...
public final class HudState {
    ...
    public void write(DataOutputStream out) throws IOException {
        ...
        // Hotbar / inventory.
        out.writeByte(selectedSlot & 0xFF);
        out.writeByte(mainInventory.size());
    ...
    public static HudState read(DataInputStream in) throws IOException {
        ...
        // Hotbar / inventory.
        h.selectedSlot = in.readUnsignedByte();
        int mainCount = in.readUnsignedByte();
        for (int i = 0; i < mainCount; i++) {
            h.mainInventory.add(IoUtil.readString(in));
        }
