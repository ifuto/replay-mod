...
public final class ReplayListScreen extends Screen {
    ...
    protected void init() {
        ...
        addDrawableChild(ButtonWidget.builder(Text.literal("戻る"), b -> close())
    ...
    private void preview(File f) {
        ...
        if (client.player != null) {
            client.inGameHud.getChatHud().addMessage(Text.literal("Preview: Space=再生/一時停止  ←→=シーク  Esc=終了"));
        }
    }
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredTextWithShadow(textRenderer,
                Text.literal("エクスポートは /replay render <name> <WxH> <fps> [mp4|png]"),
